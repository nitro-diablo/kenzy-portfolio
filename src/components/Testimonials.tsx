        ...
        <div className="grid sm:grid-cols-2 gap-5 sm:gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group p-6 sm:p-8 rounded-sm border border-border/50 hover:border-accent/20 bg-card transition-all duration-500"
            >
              {/* Stars */}
              ...
              <h3 className="text-foreground font-semibold text-base sm:text-lg mb-3 font-[var(--font-playfair)]">
                &ldquo;{testimonial.title}&rdquo;
              </h3>
              <p className="text-foreground-muted text-sm leading-[1.7] mb-5">
                &ldquo;{testimonial.quote}&rdquo;
              </p>
              <div className="flex items-center gap-2 text-[11px] text-accent/80 font-medium uppercase tracking-[0.15em]">
