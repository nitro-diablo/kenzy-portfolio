      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            className="relative rounded-sm overflow-hidden border border-border/40 h-[300px] sm:h-[400px] lg:h-full lg:min-h-[450px]"
          >
            <iframe
          ...
          >
            {/* Address Card */}
            <div className="glass rounded-sm p-5 sm:p-6 space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0 border border-accent/15">
                ...
                <div>
                  <h3 className="text-foreground font-semibold text-sm mb-1">Address</h3>
            ...
            <div className="glass rounded-sm p-5 sm:p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-semibold text-sm mb-1">Phone</h3>
                  <a
                    href="tel:+17347296453"
                    className="text-xl font-[var(--font-playfair)] text-accent hover:text-accent-light transition-colors font-bold"
                  >
                    (734) 729-6453
                  </a>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Dine-In", "Carry Out", "Catering", "Free Wi-Fi"].map((service) => (
                      <span
                        key={service}
                        className="text-[11px] font-medium px-3 py-1.5 rounded-sm bg-accent/8 text-accent border border-accent/15 tracking-wide"
                      >
                        {service}
                      </span>
                    ))}
